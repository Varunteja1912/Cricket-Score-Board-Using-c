...
struct batsman
{
    char name[25];
    char team[10];
    int runs, score, balls, toruns, tobal, ones, fours, sixes;
    ...
    do
    {
        ...
        switch (choice)
        {
            case 1:
                ...
                printf("===========================================================================\n");
                printf(" Team   Batsman        runs           balls        fours       sixes         sr   \n");
                printf("===========================================================================\n");

                pl1[plno].runs = pl1[plno].ones + 4 * pl1[plno].fours + 6 * pl1[plno].sixes;
                pl1[plno].str = (float)pl1[plno].runs / pl1[plno].balls * 100;

                printf(" %s    %-15s %-14d %-13d %-11d %-11d %-9.2f\n\n",team, pl1[plno].name, pl1[plno].runs, pl1[plno].balls, pl1[plno].fours, pl1[plno].sixes, pl1[plno].str);
            ...
            case 3:
                ...
                for (i = 0; i < 1; i++)
                {
                    pl1[i].runs = (1 * pl1[i].ones) + (4 * pl1[i].fours) + (6 * pl1[i].sixes);
                    pl3.toruns += pl1[i].runs;
                    pl1[i].str = (pl1[i].runs * 100.00) / pl1[i].balls;
                    printf(" %s     ""%-15s %-14d %-13d %-11d %-11d %-9.2f\n\n",team, pl1[i].name, pl1[i].runs, pl1[i].balls, pl1[i].fours, pl1[i].sixes, pl1[i].str);
                }
                printf("TOTAL RUNS:%d\n\n", pl3.toruns);
                printf("\n\n");
                printf("=================================================================\n");
